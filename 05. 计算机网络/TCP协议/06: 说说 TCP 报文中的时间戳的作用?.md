...
注意哦！现在服务端不是立刻回复 SYN + ACK，而是通过计算得到一个`SYN Cookie`, 将这个Cookie放到 TCP 报文的 `Fast Open`选项中，然后才给客户端返回。
...
![Alt text](./img/Snipaste_2020-07-08_16-39-51.png)
