...
![Alt text](img/Snipaste_2020-07-08_16-50-07.png)
...
![Alt text](img/Snipaste_2020-07-08_16-50-15.png)
...
![Alt text](img/Snipaste_2020-07-08_16-50-22.png)
...
因此，接收端会在 ACK 的报文首部带上缩小后的滑动窗口 140 字节，发送端对应地调整**发送窗口**的大小为 140 个字节。
